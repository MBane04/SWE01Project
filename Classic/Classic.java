...
public class Classic {
	...
	String newRound()
	{
		...
		cpuMove = getCpuMove();
		System.out.print("The CPU Chooses: ");
	...
	public static void main(String[] args) 
	{
		...
		System.out.println("Welcome to Classic Roshambo!, enter rock, paper, or scissors to play!\n");
		while(playAgain.equals("yes")) {
			...
			//every round, see if the player wants to continue
			if(game.round % 2 == 0) {
				System.out.println("Want to go 2 more rounds?(yes/no)");
		...
		if(game.playerWins > game.cpuWins) {
			...
			System.out.println("The overall winner is: CPU");
		} else {
